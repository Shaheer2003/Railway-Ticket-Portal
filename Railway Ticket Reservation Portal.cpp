...
public:
	...
	System() {  // ✅ Constructor for dynamic allocation
        train = new Train[num_of_trains] { 
            Train("Celestial Express"), Train("Quantum Voyager"), 
            Train("Nebula Navigator"), Train("Stellar Odyssey"), 
            Train("Galaxy Explorer") 
        };
        seats = 0;
    }
	...
	~System() {  // ✅ Destructor to free memory
        delete[] train;
    }
};
